...
const package_manager_detector_1 = require("../src/package-manager-detector");
// Mock child_process
...
describe('PackageManagerDetector', () => {
    ...
    let mockExecAsync;
    beforeEach(() => {
        detector = new package_manager_detector_1.PackageManagerDetector();
...
//# sourceMappingURL=package-manager-detector.spec.js.map