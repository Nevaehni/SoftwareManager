...
describe('Renderer App Controller', () => {
    ...
    test('App_controller_initializes_UI', () => {
        ...
        const selectBundleBtn = document.getElementById('select-bundle-btn') as HTMLButtonElement;
    ...
    test('Backup_button_triggers_backup', async () => {
        ...
        expect((global as any).electronAPI.backupPackages).toHaveBeenCalled();
    });
    ...
    test('Restore_button_enabled_after_bundle_selection', async () => {
        ...
        expect((global as any).electronAPI.selectFile).toHaveBeenCalled();
    ...
    test('Settings_checkbox_reflects_stored_settings', async () => {
        ...
        expect((global as any).electronAPI.getSettings).toHaveBeenCalled();
